...
define(['./workbox-800fb68e'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/(cdn|unpkg|cdnjs)\..*/i, new workbox.StaleWhileRevalidate({
