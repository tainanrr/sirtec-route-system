-- APR Completa V2 - Com lógica condicional de fotos obrigatórias
-- Execute este SQL no Supabase SQL Editor

-- Primeiro, deletar APR existente
DELETE FROM public.checklists WHERE tipo = 'apr';

-- Inserir APR completa com condições
INSERT INTO public.checklists (nome, descricao, tipo, versao, ativo, exige_localizacao, exige_assinatura, grupos) VALUES (
  'APR - Análise Preliminar de Riscos',
  'Checklist completo de análise preliminar de riscos para trabalhos em campo. Responda SIM apenas se identificar o risco no local.',
  'apr',
  '2.0',
  true,
  true,
  ...
  '[
    {
      ...
      "descricao": "Registro fotográfico obrigatório do ambiente de trabalho",
      "ordem": 1,
      "perguntas": [
        {
          "id": "p-1-1",
          ...
          "config": {
            ...
            "dica": "Tire uma foto panorâmica do local de trabalho"
          }
        }
      ]
    },
    {
      ...
      "descricao": "Identificação de riscos elétricos - Responda SIM se identificar o risco",
      "ordem": 2,
      "perguntas": [
        {
          "id": "p-2-1",
        ...
        },
        {
          ...
          "config": {
            "foto_se_sim": true,
            "alerta_se_sim": "ATENÇÃO: Risco crítico identificado!"
          }
        },
        {
          "id": "p-2-7",
        ...
        },
        {
          ...
          "grupo_id": "sec-02",
          "config": {
            "placeholder": "Descreva observações adicionais sobre riscos elétricos identificados..."
          }
        }
      ]
    },
    {
      ...
      "descricao": "Identificação de riscos de queda - Responda SIM se identificar o risco",
      "ordem": 3,
      "perguntas": [
        {
          "id": "p-3-1",
          ...
          "config": {
            "foto_se_sim": true,
            "observacao_se_sim": true,
            "alerta_se_sim": "Verifique condições da escada antes de usar!"
          }
        },
        {
          "id": "p-3-2",
          ...
          "config": {
            "foto_se_sim": true,
            "observacao_se_sim": true,
            "alerta_se_sim": "ATENÇÃO: Não utilize estruturas precárias!"
          }
        },
        {
          "id": "p-3-3",
        ...
        },
        {
          ...
          "grupo_id": "sec-03",
          "opcoes": [
            {"id": "e3-1", "texto": "Não", "valor": "nao"},
            {"id": "e3-2", "texto": "Sim", "valor": "sim", "exige_foto": true, "exige_observacao": true},
            {"id": "e3-3", "texto": "Não se aplica", "valor": "na"}
          ],
          "config": {
            "alerta_se_sim": "ATENÇÃO: Verifique marcação de limite de engaste!"
          }
        },
        {
          "id": "p-3-8",
      ...
      "perguntas": [
        {
          ...
          "config": {
            "observacao_se_sim": true,
            "alerta_se_sim": "Não inicie o serviço sem as ferramentas necessárias!"
          }
        },
        {
          "id": "p-4-2",
          ...
          "config": {
            "foto_se_sim": true,
            "observacao_se_sim": true,
            "alerta_se_sim": "Não utilize ferramentas em má condição!"
          }
        },
        {
          "id": "p-4-3",
    ...
    },
    {
      ...
      "perguntas": [
        ...
        },
        {
          ...
          "config": {
            "foto_se_sim": true,
            "alerta_se_sim": "Sinalize adequadamente a área!"
          }
        },
        {
          "id": "p-5-3",
          ...
          "grupo_id": "sec-05",
          "config": {
            "alerta_se_sim": "Acione freio de mão e calce o veículo!"
          }
        },
        {
          "id": "p-5-4",
        ...
        },
        {
          ...
          "config": {
            "foto_se_sim": true,
            "observacao_se_sim": true,
            "alerta_se_sim": "Não utilize veículo em condições inadequadas!"
          }
        },
        {
          "id": "p-5-6",
      ...
      "perguntas": [
        {
          ...
          "config": {
            "foto_se_sim": true,
            "observacao_se_sim": true,
            "alerta_se_sim": "ATENÇÃO: Verifique o local correto da intervenção!"
          }
        },
        {
          "id": "p-7-2",
      ...
      "perguntas": [
        {
          ...
          "config": {
            "foto_se_sim": true,
            "observacao_se_sim": true,
            "alerta_se_sim": "Use perneiras e EPIs adequados!"
          }
        },
        {
          "id": "p-8-2",
          ...
          "config": {
            "foto_se_sim": true,
            "alerta_se_sim": "Avalie se é seguro continuar o serviço!"
          }
        },
        {
          "id": "p-8-3",
          ...
          "grupo_id": "sec-08",
          "config": {
            "alerta_se_sim": "Use protetor auricular!"
          }
        },
        {
          "id": "p-8-4",
          ...
          "grupo_id": "sec-08",
          "config": {
            "alerta_se_sim": "Use protetor solar e vestimenta adequada!"
          }
        },
        {
          "id": "p-8-5",
    ...
    },
    {
      ...
      "descricao": "Análise final e decisão sobre execução do serviço",
      "ordem": 9,
      "perguntas": [
        {
          "id": "p-9-1",
          ...
          "grupo_id": "sec-09",
          "opcoes": [
            {"id": "a9-1", "texto": "Sim", "valor": "sim"},
            {"id": "a9-2", "texto": "Não, direito de recusa - NR-10", "valor": "nao", "exige_observacao": true, "exige_foto": true}
          ],
          "config": {
            "alerta_se_nao": "ATENÇÃO: Direito de recusa acionado! Justifique e documente."
          }
        },
        {
          "id": "p-9-2",
          "texto": "Justificativa (obrigatório em caso de direito de recusa)",
          "tipo": "texto_longo",
          "obrigatoria": false,
          "ordem": 2,
          "grupo_id": "sec-09",
          "config": {
            "placeholder": "Descreva detalhadamente o motivo do direito de recusa...",
            "condicional": {
              "pergunta_id": "p-9-1",
              "valor": "nao",
              "torna_obrigatoria": true
            }
          }
        },
        {
    ...
    },
    {
      "id": "sec-10",
      "nome": "10. ASSINATURAS",
      "descricao": "Assinaturas obrigatórias dos responsáveis pela execução",
      "ordem": 10,
      "perguntas": [
        {
          "id": "p-10-1",
        ...
        {
          "id": "p-10-5",
          "texto": "Nome do Parceiro (2) - Opcional",
          "tipo": "texto",
          "obrigatoria": false,
          "ordem": 5,
          "grupo_id": "sec-10",
          "config": {
            "placeholder": "Digite o nome completo do segundo parceiro (se houver)"
          }
        },
        {
          "id": "p-10-6",
          "texto": "Assinatura do Parceiro (2) - Opcional",
          "tipo": "assinatura",
          "obrigatoria": false,
          "ordem": 6,
          "grupo_id": "sec-10"
    ...
    {
      "id": "sec-11",
      "nome": "11. EVIDÊNCIAS FOTOGRÁFICAS",
      "descricao": "Fotos obrigatórias para comprovação",
      "ordem": 11,
      "perguntas": [
        {
          "id": "p-11-1",
          "texto": "Área de trabalho isolada (foto da área isolada e sinalizada)",
          "tipo": "foto",
          "obrigatoria": true,
          "ordem": 1,
          "grupo_id": "sec-11",
          "config": {
            "dica": "Fotografe mostrando a sinalização e isolamento da área"
          }
        },
        {
          "id": "p-11-2",
          "texto": "EPIs e EPCs utilizados (foto da equipe utilizando os equipamentos)",
          "tipo": "foto",
          "obrigatoria": true,
          "ordem": 2,
          "grupo_id": "sec-11",
          "config": {
            "dica": "Fotografe a equipe utilizando os EPIs e EPCs"
          }
        },
        {
          "id": "p-11-3",
          ...
          "grupo_id": "sec-11",
          "opcoes": [
            {"id": "te-1", "texto": "(C) Conforme", "valor": "conforme"},
            {"id": "te-2", "texto": "(NA) Não Aplicável", "valor": "na"}
          ]
        },
        {
          "id": "p-11-4",
          "texto": "Foto adicional (opcional)",
          "tipo": "foto",
          "obrigatoria": false,
          "ordem": 4,
          "grupo_id": "sec-11",
          "config": {
            "dica": "Adicione fotos extras se necessário"
          }
        }
      ]
    }
...
SELECT id, nome, tipo, ativo, 
       ...
       (SELECT SUM(jsonb_array_length(g->'perguntas')) FROM jsonb_array_elements(grupos) g) as total_perguntas
