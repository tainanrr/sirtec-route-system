...
// ============================================
// COMPONENTE PRINCIPAL - CHAT WIDGET (MOBILE)
// ============================================
...
export function ChatWidget() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      if (scrollRef.current) {
        // ScrollArea do shadcn usa um viewport interno
  ...
  // Iniciar conversa ao abrir se não tiver nenhuma
  useEffect(() => {
    if (open && !conversaAtiva && equipeId) {
      // Criar conversa com a torre automaticamente
      obterOuCriarConversa({
        id: equipeId,
        codigo: equipeCodigo,
        nome: equipeCodigo
  ...
  }, [open, conversaAtiva, equipeId, equipeCodigo, obterOuCriarConversa]);
  ...
  return (
    <>
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetTrigger asChild>
          <Button
            ...
            className={cn(
              ...
              totalNaoLidas > 0 && "animate-bounce"
            )}
          >
            <MessageCircle className="h-6 w-6" />
            {totalNaoLidas > 0 && (
              <Badge 
                className="absolute -top-1 -right-1 h-6 w-6 p-0 flex items-center justify-center bg-red-500 text-white border-2 border-white"
              >
        ...
        >
          {/* Header */}
          <SheetHeader className="p-4 border-b bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-t-3xl">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <SheetTitle className="text-white text-lg">Suporte</SheetTitle>
